...
public class EventData {
    ...
    public final Pokemon attackUser; // User of the move
    ...
    public StatusContext statusContext; // Status Condition changes

    public WeatherEffect weatherChange; // Change in weather
    
    public Protection protectionType; // The kind of damage nullifier

    public int damage; // Damage dealt by single hit
    public int totalDamageDealt; // Total damage dealt by attacker

    public int healAmount; // Total damage restored
    ...
    public double otherDamageMods; // Other move mod multipliers (From effects)
    ...
    public String toString() {
        ...
        .append(String.format("User: %s%n", this.attackUser))
        ...
        .append(String.format("Damage Dealt: %d%n", this.totalDamageDealt))
