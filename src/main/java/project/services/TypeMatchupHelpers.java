...
public class TypeMatchupHelpers {
    ...
    public static double[] calculateMatchups(Type type1, Type type2) {
    ...
    public static TypeName[] removeElement(Type[] array, Type value) {
    ...
    public static Type selectType(TypeName[] set, String prompt) {
